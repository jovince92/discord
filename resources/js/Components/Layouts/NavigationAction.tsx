    ...
    return (
        <button onClick={()=>onOpen('CreateServer')} className='group'>
            <ActionTooltip label='Add a Server' align='center' side='right'>
                <div className='flex mx-2.5 h-12 w-12 rounded-[1.5rem] group-hover:rounded-[1rem] transition-all overflow-hidden items-center justify-center bg-background dark:bg-neutral-700 group-hover:bg-emerald-500'>
